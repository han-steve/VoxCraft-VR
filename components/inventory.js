AFRAME.registerComponent("inventory", {
  ...
  init: function () {
    ...
    selectEl.innerHTML = `
        ...
        <a-box id="Grass" class="intersectable" scale="0.17 0.17 0.001" position="-0.26 0.08 -0.7"  material="shader: flat; opacity: 1; transparent: false; color: #bfbfbf"></a-box>
        <a-image scale="0.15 0.15 0.001" position="-0.255 0.08 -0.68" src="./assets/icons/grass.png"></a-image>

        <a-box id="Plank" class="intersectable" scale="0.17 0.17 0.001" position="0 0.08 -0.7"  material="shader: flat; opacity: 1; transparent: false; color: #bfbfbf" flatShading="true"></a-box>
        <a-image scale="0.15 0.15 0.001" position="0 0.08 -0.68" src="./assets/icons/plank.png"></a-image>

        <a-box id="Stone" class="intersectable" scale="0.17 0.17 0.001" position="0.26 0.08 -0.7"  material="shader: flat; opacity: 1; transparent: false; color: #bfbfbf" flatShading="true"></a-box>
